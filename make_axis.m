...
%     p3_t=p3-mean(geom.vertices);
    ...
    figure, subplot(1,4,1), trisurf(geom.faces,vert_t_r_z(1,:),vert_t_r_z(2,:),vert_t_r_z(3,:))
    axis equal
    xlabel('x'),ylabel('y'), zlabel('z')
    ...
    subplot(1,4,2), trisurf(geom.faces,vert_t_r_xz(1,:),vert_t_r_xz(2,:),vert_t_r_xz(3,:))
    axis equal
    xlabel('x'),ylabel('y'), zlabel('z')
    hold on,scatter3(p1_r(1),p1_r(2),p1_r(3),50,'filled','r')
    hold on,scatter3(p2_r(1),p2_r(2),p2_r(3),50,'filled','b')
    ...
    subplot(1,4,3), trisurf(geom.faces,vert_t_r_xyz(1,:),vert_t_r_xyz(2,:),vert_t_r_xyz(3,:))
    axis equal
    xlabel('x'),ylabel('y'), zlabel('z')
    hold on,scatter3(p1_r(1),p1_r(2),p1_r(3),50,'filled','r')
    hold on,scatter3(p2_r(1),p2_r(2),p2_r(3),50,'filled','b')
    ...
    subplot(1,4,4), trisurf(geom.faces,vert_t_r_xyz2(1,:),vert_t_r_xyz2(2,:),vert_t_r_xyz2(3,:))
    axis equal
    xlabel('x'),ylabel('y'), zlabel('z')
    hold on,scatter3(p1_r(1),p1_r(2),p1_r(3),50,'filled','r')
    hold on,scatter3(p2_r(1),p2_r(2),p2_r(3),50,'filled','b')
...
%     end
    ...
    if mean(vert_t_r_xyz2(3,:))<0
        ...
        subplot(1,2,2), trisurf(geom.faces,vert_t_r_xyz2(1,:),vert_t_r_xyz2(2,:),vert_t_r_xyz2(3,:))
        axis equal
        xlabel('x'),ylabel('y'), zlabel('z')
        hold on,scatter3(p1_r(1),p1_r(2),p1_r(3),50,'filled','r')
        hold on,scatter3(p2_r(1),p2_r(2),p2_r(3),50,'filled','b')
...
%     vert_t_r_xyz2(:,3)=vert_t_r_xyz2(:,3)-lowest_z;
    ...
    figure,trisurf(geom.faces,vert_t_r_xyz2(:,1),vert_t_r_xyz2(:,2),vert_t_r_xyz2(:,3)), hold on
    xlabel('x'),ylabel('y'),zlabel('z');
