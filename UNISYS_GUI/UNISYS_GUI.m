    ...
    methods
        ...
        function Create(self_UNISYS)
            ...
            self_UNISYS.intAct.txt_plot = uicontrol('Style','text',...
                'Units','normalized',...
                'Position',[self_UNISYS.intAct.column2x self_UNISYS.intAct.row3y+self_UNISYS.intAct.inputheight self_UNISYS.intAct.textwidth self_UNISYS.intAct.textheight],...
                'String','Plot UNISYS?',...
                'BackgroundColor',self_UNISYS.intAct.textbackground_light);
            ...
            self_UNISYS.intAct.val_plot = uicontrol('Style','popup',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column2x self_UNISYS.intAct.row3y self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight],...
                'String', {'Yes','No'},...
                'BackgroundColor','white');
