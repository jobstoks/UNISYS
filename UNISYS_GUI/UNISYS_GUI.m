classdef UNISYS_GUI < handle
    ...
    methods
        ...
        function Create(self_UNISYS)
            ...
            % Set x and y coordinates of buttons
            ...
            % Create tabs
            self_UNISYS.tabs.tgroup = uitabgroup(self_UNISYS.UIFigure);
            self_UNISYS.tabs.tab1 = uitab(self_UNISYS.tabs.tgroup,...
                'Title','Load data and required info',...
                'ButtonDownFcn',@self_UNISYS.Tab1Pushed,...
                'CreateFcn',@self_UNISYS.Tab1Pushed);
            self_UNISYS.tabs.tab2 = uitab(self_UNISYS.tabs.tgroup,...
                'Title','Visualization options',...
                'ButtonDownFcn',@self_UNISYS.Tab2Pushed);
            self_UNISYS.tabs.tab3 = uitab(self_UNISYS.tabs.tgroup,...
                'Title','Plot options',...
                'ButtonDownFcn',@self_UNISYS.Tab3Pushed);
            self_UNISYS.tabs.tab4 = uitab(self_UNISYS.tabs.tgroup,...
                'Title','Save options',...
                'ButtonDownFcn',@self_UNISYS.Tab4Pushed);
            self_UNISYS.tabs.SelectedTab = self_UNISYS.tabs.tab1;
            ...
            self_UNISYS.intAct.LoadButton = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column1x self_UNISYS.intAct.row6y self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight*2],...
            ...
            %                                 'string',regexprep('(.*)',[char(183),' $1']));
                                ...
                                hold on, axes('Units','normalized','Position',[.5 .5 .3 .3]); %Create axes
            ...
            self_UNISYS.intAct.PlotButton = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column1x self_UNISYS.intAct.row5y self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight*2],...
            ...
            self_UNISYS.intAct.CloseButton = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column1x self_UNISYS.intAct.row4y self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight*2],...
            ...
            self_UNISYS.intAct.LoadSettingsButton = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column1x self_UNISYS.intAct.row3y self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight*2],...
            ...
            self_UNISYS.intAct.CloseButton = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column5x self_UNISYS.intAct.row2y self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight*2],...
            ...
            self_UNISYS.intAct.tab1.txt_Geom_disp = uicontrol('Style','text',...
                'Units','normalized',...
                'Position',[self_UNISYS.intAct.column2x self_UNISYS.intAct.row6y+self_UNISYS.intAct.inputheight self_UNISYS.intAct.textwidth self_UNISYS.intAct.textheight],...
                'String','Geometry to display',...
                'BackgroundColor',self_UNISYS.intAct.textbackground_light);

            % Create Geometry-dropdownlist
            self_UNISYS.intAct.tab1.Geometry = uicontrol(self_UNISYS.UIFigure, ...
                'Style','popup',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column2x self_UNISYS.intAct.row6y self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight],...
            ...
            % selected yet
            self_UNISYS.intAct.tab1.txt_No_Geom_disp = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab1.txt_beats = uicontrol('Style','text',...
                'Units','normalized',...
                'Position',[self_UNISYS.intAct.column2x self_UNISYS.intAct.row4y+self_UNISYS.intAct.inputheight self_UNISYS.intAct.textwidth self_UNISYS.intAct.textheight],...
            ...
            self_UNISYS.intAct.tab1.Beats = uicontrol(self_UNISYS.UIFigure, ...
                'Style','popup',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab1.txt_fieldnames_disp = uicontrol('Style','text',...
                'Units','normalized',...
                'Position',[self_UNISYS.intAct.column3x self_UNISYS.intAct.row1y+self_UNISYS.intAct.inputheight self_UNISYS.intAct.textwidth self_UNISYS.intAct.textheight],...
                'String','Text to display',...
                'BackgroundColor',self_UNISYS.intAct.textbackground_light);

            % Create "Fieldnames to display"-textfield for input
            self_UNISYS.intAct.tab1.input_fieldnames_disp = uicontrol('style','Edit',...
                'string','AT (ms)',...
                'Units','normalized',...
            ...
            %             self_UNISYS.intAct.tab1.txt_basic_options = uicontrol('Style','text',...
            %                 'Units','normalized',...
            ...
            self_UNISYS.intAct.tab1.val_reference_buttonright = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column3x+self_UNISYS.intAct.inputwidth/2 self_UNISYS.intAct.row4y+self_UNISYS.intAct.inputheight self_UNISYS.intAct.inputwidth/2 self_UNISYS.intAct.inputheight],...
            ...
            self_UNISYS.intAct.tab1.val_reference_buttonleft = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column3x self_UNISYS.intAct.row4y+self_UNISYS.intAct.inputheight self_UNISYS.intAct.inputwidth/2 self_UNISYS.intAct.inputheight],...
            ...
            % Create "Plot"-text
            self_UNISYS.intAct.tab1.txt_plot = uicontrol('Style','text',...
                'Units','normalized',...
                'Position',[self_UNISYS.intAct.column3x self_UNISYS.intAct.row3y self_UNISYS.intAct.textwidth self_UNISYS.intAct.textheight],...
                'String','Plot UNISYS?',...
                'BackgroundColor',self_UNISYS.intAct.textbackground_light);

            % Create "Plot"-dropdown menu
            self_UNISYS.intAct.tab1.val_plot = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            % Contains base val
            self_UNISYS.intAct.tab1.val_Containsbase = uicontrol(self_UNISYS.UIFigure, ...
                'Style','checkbox',...
                'Units','normalized',...
            ...
            % Select basalnodes
            self_UNISYS.intAct.tab1.BasalNodesButton = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column2x self_UNISYS.intAct.row1y self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight*2],...
            ...
            self_UNISYS.intAct.tab2.axes=axes('Units','normalized','Position',[self_UNISYS.intAct.column4x-self_UNISYS.intAct.xgap/2 self_UNISYS.intAct.row2y-self_UNISYS.intAct.ygap/2 self_UNISYS.intAct.xspacing*4 self_UNISYS.intAct.yspacing*3+self_UNISYS.intAct.ygap/2]);
            rectangle('Position', [1 1 1 1], 'FaceColor',self_UNISYS.intAct.orange_color);
            axis off, box off

            % Draw orange text for visualization options
            self_UNISYS.intAct.tab2.txt_dev_opts_options = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            % Create "numrows"-text
            self_UNISYS.intAct.tab2.clrmap_txt_numplotsperrow = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            % Create "numrows"-val
            self_UNISYS.intAct.tab2.clrmap_val_numplotsperrow = uicontrol('style','Edit',...
                'string','1',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_txt_numrows = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_val_numrows = uicontrol('style','Edit',...
                'string','1',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_txt_map = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            % Create "colormap"-val
            self_UNISYS.intAct.tab2.clrmap_val_map = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            % Create "flipud"-text
            self_UNISYS.intAct.tab2.clrmap_txt_flipud = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            % Create "flipud"-val
            self_UNISYS.intAct.tab2.clrmap_val_flipud = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            % Create "lims"-text
            self_UNISYS.intAct.tab2.clrmap_txt_lims = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_txt_lims_lower = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_txt_lims_higher = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_val_lims_lower = uicontrol('style','Edit',...
                'Units','normalized',...
                'string','',...
            ...
            self_UNISYS.intAct.tab2.clrmap_val_lims_higher = uicontrol('style','Edit',...
                'Units','normalized',...
                'string','',...
            ...
            self_UNISYS.intAct.tab2.clrmap_txt_identical = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_val_identical = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_txt_symmetrical = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_val_symmetrical = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_txt_isolines = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            % Create "isolines"-val
            self_UNISYS.intAct.tab2.clrmap_val_isolines = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            % Create "alpha"-text
            self_UNISYS.intAct.tab2.clrmap_txt_alpha = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            % Create "alpha"-val
            self_UNISYS.intAct.tab2.clrmap_val_alpha = uicontrol('style','Edit',...
                'Units','normalized',...
            ...
            % Create "steps"-text
            self_UNISYS.intAct.tab2.clrmap_txt_steps = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            % Create "steps"-val
            self_UNISYS.intAct.tab2.clrmap_val_steps = uicontrol('style','Edit',...
                'Units','normalized',...
            ...
            % Create "custom"-text
            self_UNISYS.intAct.tab2.clrmap_txt_custom = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_txt_click = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            %             self_UNISYS.intAct.tab2.clrmap_txt_or_specify = uicontrol('Style','text',...
            %                 'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.clrmap_txt_or_load = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            %             self_UNISYS.intAct.tab2.clrmap_val_custom_specify = uicontrol('Style','Edit',...
            %                 'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.CustomButton = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab2.CustomLoadButton = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab3.axes=axes('Units','normalized','Position',[self_UNISYS.intAct.column6x-self_UNISYS.intAct.xgap/2 self_UNISYS.intAct.row5y-self_UNISYS.intAct.ygap/2 self_UNISYS.intAct.xspacing*2 self_UNISYS.intAct.yspacing*2+self_UNISYS.intAct.ygap]);
            rectangle('Position', [1 1 1 1], 'FaceColor',self_UNISYS.intAct.blue_color);
            axis off, box off

            % Draw blue text for plot options
            self_UNISYS.intAct.tab3.txt_dev_opts_blue_options = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab3.plot_txt_heart = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab3.plot_val_heart = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab3.plot_txt_bullseye = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab3.plot_val_bullseye = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab3.plot_txt_clrbar_heart = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab3.plot_val_clrbar_heart = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab3.plot_txt_clrbar_bullseye = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab3.plot_val_clrbar_bullseye = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab4.axes=axes('Units','normalized','Position',[self_UNISYS.intAct.column3x-self_UNISYS.intAct.xgap/2 self_UNISYS.intAct.ymargin/2 self_UNISYS.intAct.inputwidth+self_UNISYS.intAct.xgap self_UNISYS.intAct.ymargin/2+self_UNISYS.intAct.ygap/2+4*self_UNISYS.intAct.yspacing]);
            rectangle('Position', [1 1 1 1], 'FaceColor',self_UNISYS.intAct.red_color);
            axis off, box off

            % Draw red text for save options
            self_UNISYS.intAct.tab4.txt_save_options = uicontrol('Style','text',...
                'Units','normalized',...
                'Position',[self_UNISYS.intAct.column3x self_UNISYS.intAct.row5y+self_UNISYS.intAct.inputheight self_UNISYS.intAct.textwidth self_UNISYS.intAct.textheight],...
                'String','Save options',...
            ...
            % Create "Save"-text
            self_UNISYS.intAct.tab4.txt_save = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab4.val_save = uicontrol('Style','popup',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab4.val_savefig = uicontrol('Style','checkbox',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column3x self_UNISYS.intAct.row3y+self_UNISYS.intAct.inputheight self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight],...
            ...
            self_UNISYS.intAct.tab4.val_savepng = uicontrol('Style','checkbox',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab4.txt_savename = uicontrol('Style','text',...
                'Units','normalized',...
            ...
            self_UNISYS.intAct.tab4.val_savename = uicontrol('style','Edit',...
            ...
            self_UNISYS.intAct.tab4.SavefolderButton = uicontrol(self_UNISYS.UIFigure, ...
                'Style','pushbutton',...
                'Units','normalized',...
                'Position', [self_UNISYS.intAct.column3x self_UNISYS.intAct.row1y self_UNISYS.intAct.inputwidth self_UNISYS.intAct.inputheight],...
        ...
        function self_UNISYS=LoadButtonPushed(self_UNISYS, ~, varargin)
            ...
            if filename~=0
                ...
                drawnow;
                varnames=who;
                self_UNISYS.intAct.tab1.list_varnames_beats.String=varnames;
            end
            putInSelf
        end
        ...
        function self_UNISYS=GeometryButtonPushed(self_UNISYS, ~, varargin)
            ...
            try
                delete(self_UNISYS.intAct.tab1.txt_draw)
            end

            try
                delete(self_UNISYS.intAct.tab1.list_varnames_draw)
            end

            try
                delete(self_UNISYS.intAct.tab1.txt_fieldnames)
            end

            try
                delete(self_UNISYS.intAct.tab1.list_fieldnames_draw)
            end

            try
                if strcmp(self_UNISYS.intAct.tab1.Geometry.String{self_UNISYS.intAct.tab1.Geometry.Value},'else:') % If "else" is selected: display other options

                    % Create "Geometry to visualize"-text
                    self_UNISYS.intAct.tab1.txt_draw = uicontrol('Style','text',...
                        'Units','normalized',...
                    ...
                    self_UNISYS.intAct.tab1.list_varnames_draw = uicontrol('style','list',...
                        'Units','normalized',...
                    ...
                    self_UNISYS.intAct.tab1.list_varnames_draw.String=varnames;
        ...
        function GeomVariableSelected(self_UNISYS, ~, varargin)
            ...
            if strcmp(self_UNISYS.intAct.tab1.Geometry.String{self_UNISYS.intAct.tab1.Geometry.Value},'else:')
                var_todraw=self_UNISYS.intAct.tab1.list_varnames_draw.String{self_UNISYS.intAct.tab1.list_varnames_draw.Value};

                %Check if variable exists
                varnr_todraw=find(strcmp(varnames,var_todraw));
            else
                var_todraw=self_UNISYS.intAct.tab1.Geometry.String{self_UNISYS.intAct.tab1.Geometry.Value};
                varnr_todraw=1;
            end
            ...
            try
                if varnr_todraw~=0 & ~isempty(varnr_todraw)
                    ...
                    ax_geom=axes('Units','normalized','Position',[.6 .6 .3 .3]); %Create axes
                end

                if isfield(self_UNISYS.intAct,'val_reference')
                    if ~isnan(str2double(self_UNISYS.intAct.tab1.val_reference.String))
                        ref=str2double(self_UNISYS.intAct.tab1.val_reference.String);
                    else
                        ref=eval(ref);
                    end
                elseif isfield(self_UNISYS.intAct,'list_reference_varnames_draw')
                    if ~isnan(str2double(eval(self_UNISYS.intAct.tab1.val_reference.String{self_UNISYS.intAct.tab1.val_reference.Value})))
                        ref=eval(str2double(eval(self_UNISYS.intAct.tab1.val_reference.String{self_UNISYS.intAct.tab1.val_reference.Value})));
                    end
                else
                    ref=0;
                end
                ...
                if isstruct(eval(var_todraw)) %If this variable is a struct
                    ...
                    elseif isfield(eval(var_todraw),'nodes') %Check if 'nodes' field exists
                        ...
                        self_UNISYS.intAct.tab1.txt_fieldnames = uicontrol('Style','text',...
                            'Units','normalized',...
                        ...
                        % Fieldnames for geom
                        self_UNISYS.intAct.tab1.list_fieldnames_draw = uicontrol('style','list',...
                            'Units','normalized',...
                        ...
                        self_UNISYS.intAct.tab1.list_fieldnames_draw.String=fnames_h;
                    end
                ...
                if ~isempty(self_UNISYS.intAct.tab1.Beats.String{self_UNISYS.intAct.tab1.Beats.Value}) %Check if any color can be given
                    if strcmp(self_UNISYS.intAct.tab1.Beats.String{self_UNISYS.intAct.tab1.Beats.Value},'else:') %Use different variable name
                        varfieldname=[self_UNISYS.intAct.tab1.list_varnames_beats.String{self_UNISYS.intAct.tab1.list_varnames_beats.Value} '(1).' self_UNISYS.intAct.tab1.list_fieldnames_beats.String{self_UNISYS.intAct.tab1.list_fieldnames_beats.Value}];
                    else % Use beats
                        varfieldname=[self_UNISYS.intAct.tab1.Beats.String{self_UNISYS.intAct.tab1.Beats.Value} '(1).' self_UNISYS.intAct.tab1.list_fieldnames_beats.String{self_UNISYS.intAct.tab1.list_fieldnames_beats.Value}];
                    end
                else
                    varfieldname= [self_UNISYS.intAct.tab1.Geometry.String{self_UNISYS.intAct.tab1.Geometry.Value} '.' fieldname_geom '(:,3)'];
                end
                ...
                axis equal
                self_UNISYS.intAct.tab1.txt_No_Geom_disp.String='Geometry';

                % Check if isolines should be drawn
                draw_isolines= self_UNISYS.intAct.tab2.clrmap_val_isolines.String{self_UNISYS.intAct.tab2.clrmap_val_isolines.Value};
                ...
                if draw_isolines
                    isocell{1}=eval([self_UNISYS.intAct.tab1.Geometry.String{self_UNISYS.intAct.tab1.Geometry.Value} '.faces']);
                    isocell{2}=eval([self_UNISYS.intAct.tab1.Geometry.String{self_UNISYS.intAct.tab1.Geometry.Value} '.vertices']);


                    if ~strcmp(self_UNISYS.intAct.tab2.clrmap_val_steps.String,'') && str2double(self_UNISYS.intAct.tab2.clrmap_val_steps.String)>0
                        stepsize=str2double(self_UNISYS.intAct.tab2.clrmap_val_steps.String);
                    else
                ...
                % Change alpha
                if ~isempty(self_UNISYS.intAct.tab2.clrmap_val_alpha.String) && ~isnan(str2double(self_UNISYS.intAct.tab2.clrmap_val_alpha.String))
                    ax_geom.Children(end).EdgeAlpha=str2double(self_UNISYS.intAct.tab2.clrmap_val_alpha.String);
                end
        ...
        function GeomFieldnameSelected(self_UNISYS, ~, varargin)
            ...
            var_todraw=self_UNISYS.intAct.tab1.list_varnames_draw.String{self_UNISYS.intAct.tab1.list_varnames_draw.Value};
            fieldname_todraw=self_UNISYS.intAct.tab1.list_fieldnames_draw.String{self_UNISYS.intAct.tab1.list_fieldnames_draw.Value};
            try
                ax_geom=axes('Units','normalized','Position',[.5 .5 .5 .5]);
        ...
        function self_UNISYS=BeatsButtonPushed(self_UNISYS, ~, varargin)
            ...
            try
                delete(self_UNISYS.intAct.tab1.Beats_txt_else)
            end

            try
                delete(self_UNISYS.intAct.tab1.list_varnames_beats)
            end

            try
                delete(self_UNISYS.intAct.tab1.txt_fieldname_beats)
            end

            try
                delete(self_UNISYS.intAct.tab1.list_fieldnames_beats)
            end

            try
                if strcmp(self_UNISYS.intAct.tab1.Beats.String{self_UNISYS.intAct.tab1.Beats.Value},'else:') % If "else" is selected: display other options

                    % Create "Beats-variable to visualize"-text
                    self_UNISYS.intAct.tab1.Beats_txt_else = uicontrol('Style','text',...
                        'Units','normalized',...
                    ...
                    self_UNISYS.intAct.tab1.list_varnames_beats = uicontrol('style','list',...
                        'Units','normalized',...
        ...
        function Beats_VarName_Selected(self_UNISYS, ~, varargin)
            ...
            try
                delete(self_UNISYS.intAct.tab1.txt_fieldnames_beats)
            end
            try
                delete(self_UNISYS.intAct.tab1.list_fieldnames_beats)
            end
            ...
            if strcmp(self_UNISYS.intAct.tab1.Beats.String{self_UNISYS.intAct.tab1.Beats.Value},'beats')
                var_tobeat='beats';
            else
                var_tobeat=self_UNISYS.intAct.tab1.list_varnames_beats.String{self_UNISYS.intAct.tab1.list_varnames_beats.Value};
            end

            if isstruct(eval(var_tobeat))
                % Make and check the list of fieldnames
                % Create "Beats fieldname to visualize"-text
                self_UNISYS.intAct.tab1.txt_fieldnames_beats = uicontrol('Style','text',...
                    'Units','normalized',...
                ...
                self_UNISYS.intAct.tab1.list_fieldnames_beats = uicontrol('style','list',...
                    'Units','normalized',...
                ...
                self_UNISYS.intAct.tab1.list_fieldnames_beats.String=fnames_h1(good_fieldnames);
        ...
        function draw_heart_with_clrbar(self_UNISYS, ~, varargin)
            ...
            flipud_var=self_UNISYS.intAct.tab2.clrmap_val_flipud.String{self_UNISYS.intAct.tab2.clrmap_val_flipud.Value};
            ...
            symmetrical=self_UNISYS.intAct.tab2.clrmap_val_symmetrical.String{self_UNISYS.intAct.tab2.clrmap_val_symmetrical.Value};
            ...
            colorbar_type=self_UNISYS.intAct.tab2.clrmap_val_map.String{self_UNISYS.intAct.tab2.clrmap_val_map.Value};
            ...
            % Set limits
            if ~isempty(get(self_UNISYS.intAct.tab2.clrmap_val_lims_lower,'String')) && ~isempty(get(self_UNISYS.intAct.tab2.clrmap_val_lims_higher,'String'))
                lims_colorbar=[str2double(get(self_UNISYS.intAct.tab2.clrmap_val_lims_lower,'String')) str2double(get(self_UNISYS.intAct.tab2.clrmap_val_lims_higher,'String'))];
                self_UNISYS.intAct.tab2.clrmap_txt_identical.BackgroundColor=[1 0 0]; % 'Identical' flag does not work if manual limits are set
                self_UNISYS.intAct.tab2.clrmap_txt_symmetrical.BackgroundColor=[1 0 0]; % 'Symmetrical' flag does not work if manual limits are set
                ...
                self_UNISYS.intAct.tab2.clrmap_txt_identical.BackgroundColor=self_UNISYS.intAct.textbackground_light;
                self_UNISYS.intAct.tab2.clrmap_txt_symmetrical.BackgroundColor=self_UNISYS.intAct.textbackground_light;
                lims_colorbar=[min(ax_geom.Children(end).FaceVertexCData) max(ax_geom.Children(end).FaceVertexCData)];
            end

            % Check stepsize
            if iscell(self_UNISYS.intAct.tab2.clrmap_val_steps.String) && ~isempty(self_UNISYS.intAct.tab2.clrmap_val_steps.String{1})
                stepsize=str2double(self_UNISYS.intAct.tab2.clrmap_val_steps.String{1});
                change_colormap=1;
            elseif iscell(self_UNISYS.intAct.tab2.clrmap_val_steps.String) && ~isempty(self_UNISYS.intAct.tab2.clrmap_val_steps.String{1})
                stepsize=str2double(self_UNISYS.intAct.tab2.clrmap_val_steps.String);
                change_colormap=1;
            else
                change_colormap=0;
        ...
        function self_UNISYS=Tab1Pushed(self_UNISYS, ~, varargin)
            self_UNISYS.remove_tabs('tab1')
        end

        function self_UNISYS=Tab2Pushed(self_UNISYS, ~, varargin)
            self_UNISYS.remove_tabs('tab2')
        end

        function self_UNISYS=Tab3Pushed(self_UNISYS, ~, varargin)
            self_UNISYS.remove_tabs('tab3')
        end

        function self_UNISYS=Tab4Pushed(self_UNISYS, ~, varargin)
            self_UNISYS.remove_tabs('tab4')
        end

        function self_UNISYS=remove_tabs(self_UNISYS,tab)
            tabs_to_remove=find(1-ismember(1:4,str2double(tab(end))));

            for lp_tab=1:length(tabs_to_remove)
                try
                    fns_tab=eval(['fieldnames(self_UNISYS.intAct.tab' num2str(tabs_to_remove(lp_tab)) ');']);
                    for lp_fns=1:length(fns_tab)
                        try
                            eval(['self_UNISYS.intAct.tab' num2str(tabs_to_remove(lp_tab)) '.(fns_tab{lp_fns}).Visible=0;']);
                        end
                    end
                end
            end
            ...
            try
                fns_tab=eval(['fieldnames(self_UNISYS.intAct.tab' tab(end) ');']);
                for lp_fns=1:length(fns_tab)
                    try
                        eval(['self_UNISYS.intAct.tab' tab(end) '.(fns_tab{lp_fns}).Visible=1;']);
                    end
                end
            end
        ...
        function define_UNISYS_inputs(self_UNISYS, ~, varargin)
            ...
            elseif strcmp(self_UNISYS.intAct.tab1.Beats.String{self_UNISYS.intAct.tab1.Beats.Value},'else:')
                % else
                UNISYS_inputs.beats=self_UNISYS.intAct.tab1.list_varnames_beats.String{self_UNISYS.intAct.tab1.list_varnames_beats.Value};
            else
                UNISYS_inputs.beats='';
            end
            ...
            if ~isempty(UNISYS_inputs.beats)
                UNISYS_inputs.fieldnames_input=self_UNISYS.intAct.tab1.list_fieldnames_beats.String{self_UNISYS.intAct.tab1.list_fieldnames_beats.Value};
            end
            ...
            if ~isempty(self_UNISYS.intAct.tab2.clrmap_val_numplotsperrow.String) && ~isnan(str2double(self_UNISYS.intAct.tab2.clrmap_val_numplotsperrow.String))
                UNISYS_inputs.dev_opts.clrmap.numplotsperrow=str2double(self_UNISYS.intAct.tab2.clrmap_val_numplotsperrow.String);
            end

            %dev_opts.clrmap.numrows
            if ~isempty(self_UNISYS.intAct.tab2.clrmap_val_numrows.String) && ~isnan(str2double(self_UNISYS.intAct.tab2.clrmap_val_numrows.String))
                UNISYS_inputs.dev_opts.clrmap.numrows=str2double(self_UNISYS.intAct.tab2.clrmap_val_numrows.String);
            end

            %dev_opts.clrmap.steps
            if ~isempty(self_UNISYS.intAct.tab2.clrmap_val_steps.String) && ~isnan(str2double(self_UNISYS.intAct.tab2.clrmap_val_steps.String))
                UNISYS_inputs.dev_opts.clrmap.steps=str2double(self_UNISYS.intAct.tab2.clrmap_val_steps.String);
            end

            %dev_opts.clrmap.map
            UNISYS_inputs.dev_opts.clrmap.map= self_UNISYS.intAct.tab2.clrmap_val_map.String{self_UNISYS.intAct.tab2.clrmap_val_map.Value};

            %dev_opts.clrmap.map_spec
            if strcmp(self_UNISYS.intAct.tab2.clrmap_val_map.String{self_UNISYS.intAct.tab2.clrmap_val_map.Value},'custom')
                UNISYS_inputs.dev_opts.clrmap.map_spec=color_custom;
            end

            %dev_opts.clrmap.flipud
            if strcmp(self_UNISYS.intAct.tab2.clrmap_val_flipud.String{self_UNISYS.intAct.tab2.clrmap_val_flipud.Value},'Yes')
                UNISYS_inputs.dev_opts.clrmap.flipud=1;
            elseif strcmp(self_UNISYS.intAct.tab2.clrmap_val_flipud.String{self_UNISYS.intAct.tab2.clrmap_val_flipud.Value},'No')
                UNISYS_inputs.dev_opts.clrmap.flipud=0;
            end

            %dev_opts.clrmap.lims
            if ~isempty(self_UNISYS.intAct.tab2.clrmap_val_lims_lower.String) && isempty(self_UNISYS.intAct.tab2.clrmap_val_lims_higher.String) && ~isnan(str2double(self_UNISYS.intAct.tab2.clrmap_val_lims_lower.String)) && isnan(str2double(self_UNISYS.intAct.tab2.clrmap_val_lims_lower.String))
                UNISYS_inputs.dev_opts.clrmap.lims= [str2double(self_UNISYS.intAct.tab2.clrmap_val_lims_lower.String) str2double(self_UNISYS.intAct.tab2.clrmap_val_lims_higher.String)];
            end

            %dev_opts.clrmap.identical
            if strcmp(self_UNISYS.intAct.tab2.clrmap_val_identical.String{self_UNISYS.intAct.tab2.clrmap_val_identical.Value},'Yes')
                UNISYS_inputs.dev_opts.clrmap.identical=1;
            elseif strcmp(self_UNISYS.intAct.tab2.clrmap_val_identical.String{self_UNISYS.intAct.tab2.clrmap_val_identical.Value},'No')
                UNISYS_inputs.dev_opts.clrmap.identical=0;
            end

            %dev_opts.clrmap.symmetrical
            if strcmp(self_UNISYS.intAct.tab2.clrmap_val_symmetrical.String{self_UNISYS.intAct.tab2.clrmap_val_symmetrical.Value},'Yes')
                UNISYS_inputs.dev_opts.clrmap.symmetrical=1;
            elseif strcmp(self_UNISYS.intAct.tab2.clrmap_val_symmetrical.String{self_UNISYS.intAct.tab2.clrmap_val_symmetrical.Value},'No')
                UNISYS_inputs.dev_opts.clrmap.symmetrical=0;
            end

            %dev_opts.clrmap.isolines
            if strcmp(self_UNISYS.intAct.tab2.clrmap_val_isolines.String{self_UNISYS.intAct.tab2.clrmap_val_isolines.Value},'Yes')
                UNISYS_inputs.dev_opts.clrmap.isolines=1;
            elseif strcmp(self_UNISYS.intAct.tab2.clrmap_val_isolines.String{self_UNISYS.intAct.tab2.clrmap_val_isolines.Value},'No')
                UNISYS_inputs.dev_opts.clrmap.isolines=0;
            end

            %dev_opts.clrmap.alpha
            if ~isempty(self_UNISYS.intAct.tab2.clrmap_val_alpha.String) && ~isnan(str2double(self_UNISYS.intAct.tab2.clrmap_val_alpha.String))
                UNISYS_inputs.dev_opts.clrmap.alpha= str2double(self_UNISYS.intAct.tab2.clrmap_val_alpha.String);
            end
